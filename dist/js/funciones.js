...
exports.calculoDescuentoPorAportes = exports.adPlan = exports.agruparYTransformarPlanes = exports.combinePlansWithPrices = exports.valorGaleno = exports.valorOmint = exports.valorPremedic = exports.valorSancorSalud = exports.productIdOmint = exports.productIdPremedic = exports.productIdGaleno = exports.productID = exports.tipoAsociado = exports.grupoFamiliar = void 0;
...
function productIdPremedic(edad_1, edad_2, tipoAsoc, numHijos) {
    let edadIdPremedic = '';
    let age2 = edad_2;
    let age = edad_1;
    if (edad_2 === null) {
...
function valorSancorSalud(edad_1, edad_2, kids, precio1Hijo, precio2Hijo, precioTitular, preciosConyuge, numhijo2, tipoIngreso, tipoDeDato, sueldo, aportantes, grupoFam, segvida_1, segvida_2, supra, aficheq, bonAfinidadporcentaje, gen) {
    let edad1 = edad_1;
    let edad2 = edad_2;
    ...
    for (let j in valor_plan_sancor) {
        ...
        plan.promoPorcentaje = bonAfinidad;
        plan.promoDescuento = bonAfinidadMonto;
        plan.valorLista = valor_plan_sancor[j];
        plan.aporteOS = bonifAport;
        array.push(plan);
...
function valorPremedic(edad2, numHijo, valorAdultosPremedic, preciohm25, preciohm1, edadIdPremedic, afiche, bonAf, tipoIngreso, aportantes, sueldo) {
    let cantAport = aportantes;
    ...
    for (let j in valor_plan_premedic) {
        ...
        if (tipoIngreso === "M" || tipoIngreso === "D") {
            ...
            console.log('bonifAport :' + bonifAport);
        }
        else {
            precio_final_a_pagar = valor_total_plan;
        }
        ...
        plan.promo = bonAfinidadMonto;
        plan.promoPorcentaje = bonAfinidad;
        plan.promoDescuento = bonAfinidadMonto;
        plan.valorLista = valor_plan_premedic[j];
        plan.aporteOS = bonifAportPremedic;
        array.push(plan);
        let arrayLength = arrPlan.length;
...
function valorGaleno(edad_1, edad_2, numkids, precioGaleno, aporte_OS, haberesODescOS, tipoAsoc, cantAport) {
...
function adPlan(planName, valor_plan) {
    arrPlan.push(planName);
    todosPrecios.push(valor_plan);
}
exports.adPlan = adPlan;
// Función para para calcular aportes a la obra social
function calculoDescuentoPorAportes(tipo_IngresoPDMI, eleccionSueldoOAporte, sueldoSueldoOAporte, porporsentajeDeAPorte, categoria_Mono, arrayValorMonotXCategoria, beneficiariosF184) {
    ...
    if (tipo_IngresoPDMI == "D") {
        if (eleccionSueldoOAporte.includes('Sueldo')) {
            ...
            deduccionAportesObraSocial = deduccionAportesObraSocial + (aportantes * aportMonGaleno);
        }
        ;
    }
        ...
        deduccionAportesObraSocial = 0;
    }
    ;
    return deduccionAportesObraSocial;
}
exports.calculoDescuentoPorAportes = calculoDescuentoPorAportes;
