...
function valor_prepagas(prices, grupo, arrayDeducciones) {
    ...
    console.log(prices);
    let omint = [];
    omint = (0, index_1.valor_Omint)(prices, grupo, arrayDeducciones);
    console.log(' valor_OMINT ', omint);
    let Premedic = [];
    Premedic = (0, index_1.valor_Premedic)(prices, grupo, arrayDeducciones);
    console.log(' valor_Premedic ', Premedic);
    let SanCor = [];
    SanCor = (0, index_1.valor_SanCor)(prices, grupo, arrayDeducciones);
    console.log(' valor_SanCor ', SanCor);
    let Galeno = [];
    Galeno = (0, index_1.valor_Galeno)(prices, arrayDeducciones);
    console.log(' valor_Galeno ', Galeno);
    let Swiss = [];
    Swiss = (0, index_1.valor_Swiss)(prices, grupo, arrayDeducciones);
    console.log(' valor_Swiss ', Swiss);
    let Doctored = [];
    Doctored = (0, index_1.valor_Doctored)(prices, grupo, arrayDeducciones);
    console.log(' valor_Doctored ', Doctored);
    let Prevencion = [];
    Prevencion = (0, index_1.valor_Prevencion)(prices, arrayDeducciones);
    console.log(' valor_Prevencion ', Prevencion);
    let Avalian = [];
    Avalian = (0, index_1.valor_Avalian)(prices, grupo, arrayDeducciones);
    console.log(' valor_Avalian ', Avalian);
    let Ras = [];
    Ras = (0, index_1.valor_Ras)(prices, grupo, arrayDeducciones);
    console.log(' valor_Ras ', Ras);
    let Cristal = [];
    Cristal = (0, index_1.valor_Cristal)(prices, grupo, arrayDeducciones);
    console.log(' valor_Cristal ', Cristal);
    let Luispasteur = [];
    Luispasteur = (0, index_1.valor_Luispasteur)(prices, grupo, arrayDeducciones);
    console.log(' valor_Luispasteur ', Luispasteur);
    let Bayresplan = [];
    Bayresplan = (0, index_1.valor_Bayresplan)(prices, grupo, arrayDeducciones);
...
function ids_prepagas(grupo, arrayDeducciones) {
    // <! ----------SANCOR---------------------------------------------------->
    let idSancor = (0, index_2.productIDSancor)(grupo, arrayDeducciones);
    console.log(idSancor);
    // <! -----------------------------OMINT---------------------------------------------------->
    let idOmint = (0, index_2.productIdOmint)(grupo, arrayDeducciones);
    console.log(idOmint);
    // <! -----------------------------GALENO--------------------------------------------------->
    let idGaleno = (0, index_2.productIdGaleno)(grupo, arrayDeducciones);
    console.log(idGaleno);
    // <! ----------SWISS----------------------------------------------------------------------->
    let idSwiss = (0, index_2.productIdSwiss)(grupo, arrayDeducciones);
    console.log(idSwiss);
    // <! ----------MEDIFE---------------------------------------------------->
    let idsMedife = (0, index_2.productIdMedife)(grupo, arrayDeducciones);
    console.log(idsMedife);
    // <! ----------PREVENCION---------------------------------------------------->
    let idPrevencion = (0, index_2.productIdPrevencion)(grupo, arrayDeducciones);
    console.log(idPrevencion);
    // <! ----------DOCTORED---------------------------------------------------->
    let IdDoctored = (0, index_2.productIdDoctored)(grupo, arrayDeducciones);
    console.log(IdDoctored);
    // <! ----------AVALIAN---------------------------------------------------->
    let IdsAvalian = (0, index_2.productIdAvalian)(grupo, arrayDeducciones);
    console.log(IdsAvalian);
    // <! ----------CRISTAL y RAS---------------------------------------------------->
    let idsCristalyRas = (0, index_2.productIdRasCristal)(grupo, arrayDeducciones);
    console.log(idsCristalyRas);
    // <! ----------LUIS PASTEUR---------------------------------------------------->
    let idsLuisPasteur = (0, index_2.productIdLuisPasteur)(grupo, arrayDeducciones);
    console.log(idsLuisPasteur);
    // <! ----------ASMEPRIV---------------------------------------------------->
    let idsAsmepriv = (0, index_2.productIdAsmepriv)(grupo, arrayDeducciones);
    console.log(idsAsmepriv);
    // <! ----------BAYRES PLAN---------------------------------------------------->
    let idsBayresPlan = (0, index_2.productIBayres)(grupo);
    console.log(idsBayresPlan);
    // <! ----------HOMINIS---------------------------------------------------->
