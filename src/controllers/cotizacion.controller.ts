...
const omintPlanes = filteredPlans.filter((plan: { empresa: string; }) => plan.empresa === 'OMINT');
const otrasEmpresasPlanes = filteredPlans.filter((plan: { empresa: string; }) => plan.empresa !== 'OMINT');
